// Package name stores and accesses the destination name in and from a
...
// nameKey is the key for the destination name values in
...
var nameKey key = "destination-name"
...
// FromContext returns the destination name value stored in ctx, if any.
