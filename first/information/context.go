// Package information stores and accesses the values defined in this package in
...
type Value struct {
	// ID represents the ID of the first information.
	ID string `json:"id"`
}

// Equals checks whether the properties of the first value equals the
