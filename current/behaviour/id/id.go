// Package id stores and accesses the current behaviour ID in and from a
...
// idKey is the key for the current behaviour ID values in
// github.com/the-anna-project/context/spec.Context. Clients use id.NewContext
// and id.FromContext instead of using this key directly.
var idKey key = "current-behaviour-id"
...
// FromContext returns the current behaviour ID value stored in ctx, if any.
